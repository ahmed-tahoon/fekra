    ...
    layout: [
      {
        ...
        body: 'Fekra helps companies scale with carefully vetted software engineers and a structured technical hiring process.',
        ctas: [
          { variant: 'primary', link: route('Book a 30-Min Meeting', '/meeting', 'booking_cta_click') },
          { variant: 'secondary', link: route('Contact us', '/contact') },
        ],
        stats: [
          { value: '100+', label: 'Top Talents' },
